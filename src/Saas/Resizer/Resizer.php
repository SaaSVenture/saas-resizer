<?php
namespace Saas\Resizer;
use Saas\Resizer\Helpers\File;
...
class Resizer {
	 ...
	 * @param mixed $file The file array provided by Laravel's Input::file('field_name') , a path to a file or 
	 * a Symfony\Component\HttpFoundation\File\UploadedFile object by by Laravel 4's Input::file('field_name') 
	 */
	...
	private function open_image( $file )
	{
		if ($file instanceof \Symfony\Component\HttpFoundation\File\UploadedFile) {
			...
			$mime = File::mime( strtolower(File::extension($file)));
			$file_path = $file;
		}
